...
<div class="flex items-center justify-center bg-gray-100">
    ...
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mt-2" action="/courses" method="POST" id="course_form">
        <h1 class="block text-sm font-bold mb-2">Create New Course:</h1>
        @csrf
        ...
        <label class="block text-gray-700 text-sm font-bold mb-2" for="teacher">
            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"  type="text" name="teacher" id="teacher" list="teachers" placeholder="Type to search for teacher...">
